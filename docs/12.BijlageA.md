...
Aanpassing:
De bij relatie "resulteertIn" is in het schema toegevoegd dat het voidable is. Daarmee is het in overeenstemming met het model. 
...
Aanpassing:
De reguliere expressie bij het attribuut "bronhouder" is in het formeel patroon is aangepast van [A-Z,a-z, ,-]{1,100} naar ^(?!.{0,100}[.]).{1,100}$