...
- IMEV-onderdeel: Nieuw diagram met nieuw subtype van BKLActiviteit
- Aanpassing: Nieuw subtype van BKLActiviteit: OpslagVuurwerkF1F2F3T1T2_GeenVergunningplicht met dezelfde attributen als OpslagVuurwerkF1F2F3T1T2_Vergunningplicht uit VIII-B
...
- IMEV-diagram: VII-B.6: Exploiteren van een energieopslagsysteem, vergunningvrij en berekende afstanden
- IMEV-onderdeel: Nieuw diagram met nieuw subtype van BKLActiviteit en nieuw referentieEVContour
...
- Aanpassing:
Bij de volgende enumeraties is de waarde 'gegevenInTransitie' verwijderd:
...
- Milieu Belastende Activiteit(en): alle UML-diagrammen 
...
Aanpassing:
In de volgende 2 enumeraties zijn meerdere wijzigingen in de schrijfwize van de waardes doorgevoerd:  
