...
- IMEV-diagram: VII-B.3.2: Opslaan van brandbare gevaarlijke stoffen in verpakking zonder fluor-, chloor-, broom-, stikstof- of zwavelhoudende verbindingen
...
- Aanpassing: 
	- Nieuw subtype van BKLActiviteit: ExploiterenEnergieOpslagSysteem_VasteAfstandGeenVergunningplicht met attributen:
		- typeEnergieopslagysteem
		- typeEnergiedrager
		- capaciteitEOS
		- gecertificeerd
		- aantalBatterijcellen
		- maximaleModulegrootte
		- maximaleRekgrootte
		- categorieGebruiksduurMobieleEOS
	- Meerdere nieuwe enumeraties en één keuzeobject t.b.v bovenstaande attributen
	- Nieuw referentieEVContour: EnergieOpslagSysteem met attributen voor geometrie en oppervlakte en 2 constraints
	- Als EVContouren:
		- PRContour
...
- Aanpassing:
	- Nieuw subtype van BKLActiviteit: OpslagEnergiedragersElektrischeEnergie_VasteAfstandGeenVergunningplicht met attributen:
		- typeEnergiedrager
		- levensfaseEnergiedrager
		- opslagdichtheidOfVeiligheidsniveau
		- aantalBatterijcellen
	- Meerdere nieuwe enumeraties en één keuzeobject t.b.v bovenstaande attributen
	- Nieuw referentieEVContour: OpslagReferentieEnergiedrager met als attributen
		- geometrie
		- geometrieMetadatagegevens
		- buiten
		- oppervlakte
	- Als EVContouren:
		- PRContour
...
- IMEV-onderdeel: Nieuw diagram met nieuw subtype van BKLActiviteit en nieuw referentieEVContour
- Aanpassing: 
	- Nieuw subtype van BKLActiviteit: ExploiterenEnergieOpslagSysteem_TeBerekenenAfstandVergunningplicht met attributen:
		- typeEnergieopslagysteem
		- typeEnergiedrager
		- specifiekeCapaciteitEOS
	- Meerdere nieuwe enumeraties (Let op: een langere voor TypeEnergiedrager dan bij VII-A.13 en VII-D.3)
	- Nieuw referentieEVContour: EnergieOpslagSysteem met attributen voor geometrie en oppervlakte en 2 constraints
	- Als EVContouren:
		- PRContour
		- GifwolkAandachtsgebied
...
- IMEV-onderdeel: Nieuw diagram met nieuw subtype van BKLActiviteit en nieuw referentieEVContour
- Aanpassing: 
	- Nieuw subtype van BKLActiviteit: OpslagEnergiedragersElektrischeEnergie_TeBerekenenAfstandVergunningplicht met attributen:
		- typeEnergiedrager
		- categorieOpslagdichtheid
		- maximaleOpslagcapaciteit
	- Meerdere nieuwe enumeraties
	- Nieuw referentieEVContour: OpslagReferentieEnergiedrager met als attributen
		- geometrie
		- geometrieMetadatagegevens
		- buiten
...
- IMEV-onderdeel: Nieuw diagram met nieuw subtype van BKLActiviteit en nieuw referentieEVContour
- Aanpassing: Zoals VII-A.13 (issue #137) maar dan met een nieuw subtype van BKLActiviteit: ExploiterenEnergieOpslagSysteem_BerekendeAfstandGeenVergunningplicht
...
- IMEV-onderdeel: Nieuw diagram met nieuw subtype van BKLActiviteit en nieuw referentieEVContour
- Aanpassing: Als VII-A.14 (issue #141) met nieuw subtype van BKLActiviteit: OpslagEnergiedragersElektrischeEnergie_TeBerekendenAfstandGeenVergunningplicht
...
- Aanpassing: 
	- VII-B.3 is vernummerd naar VII-B.3.1 en hernoemd naar: "Opslaan van brandbare gevaarlijke stoffen in verpakking met fluor-, chloor-, broom-, stikstof- of zwavelhoudende verbindingen"
...
- Aanpassing: Voor MBA VII-E.10 zijn de twee onderliggende objecttypen ingevoerd ter vervanging van de oude:
	- TankenVoertuigenEnWerktuigenLNG_TeberekenenAfstandVergunningsplicht
	- TankstationLNGVoertuigen_TeBerekenenAfstandVergunningplicht
...
- IMEV-onderdeel: subtypes van BKLActiviteit
- Aanpassing:
	- Voor MBA VII-B.5 zijn de twee onderliggende objecttypen ingevoerd ter vervanging van de oude:
...
- Aanpassing:
	- Bij hierboven genoemde objecttypes is het verplicht gemaakt om bij het opgeven van de geometrie ook meta-informatie op te nemen in het nieuwe veld met de naam: geometrieMetagegevens. Deze bevat een gestructureerd datatype GeometrieMetagegevens waarin de metagegevens van de bron opgenomen kunnen worden.
De volgende broninformatie wordt daarin opgenomen:
	...
	- De nieuwe enumeratie Bronregistratie bevat de volgende waarden:
		- BAG
		- BGT
		- BRK
		- BRO
		...
		- zelfingewonnen
		- overig  
	- De nu al bestaande verwijzing naar het ID in een basisregistratie, wordt dan verplaatst naar het veld idInBronregistratie in GeometrieMetagegevens
...
- Aanpassing:
	- Het optionele attribuut "informatieGeheim" is toegevoegd aan het objecttype "ExterneVeiligheidsObject". Het attribuut is een boolean.
	- Daarnaast is het optionele attribuut "grondslaginfo" toegevoegd aan het objecttype "BKLActiviteit". Het attribuut "grondslagInfo" bevat een gestructureerd datatype "Grondslag". Deze bevat de volgende attributen:
	...
	- De nieuwe enumeratie GrondslagGeheimhouding bevat de volgende waarden:
...
Aanpassing:
In het constaint van [KetsbaarGebouw](https://docs.geostandaarden.nl/imev/imev/#global_class_IMEVbasis_KwetsbaarGebouw) stond "idPandBAGEnOfidAdresseerbaarObjeceBAG"
 en dat is vervangen door "idPandBAGEnOfidAdresseerbaarObjectBAG".
