...
- Aanpassing: 
	...
	- Nieuw referentieEVContour: EnergieOpslagSysteem met alleen geometrie
	- Als EVContouren:
		- PRContour
...
- Aanpassing:
	- Nieuw subtype van BKLActiviteit: OpslagEnergiedragersElektrischeEnergie_VasteAfstandGeenVergunningplicht met attributen:
		...
		- aantalBatterijcellen
	- Meerdere nieuwe enumeraties en één keuzeobject t.b.v bovenstaande attributen
	- Nieuw referentieEVContour: EnergiedragerOpslag met alleen geometrie
	- Als EVContouren:
		- PRContour
		- GifwolkAandachtsgebied
		- ExplosieAandachtsgebied
...
- IMEV-onderdeel: Nieuw diagram met nieuw subtype van BKLActiviteit en nieuw referentieEVContour
- Aanpassing: Als VII-A.13 met nieuw subtype van BKLActiviteit: ExploiterenEnergieOpslagSysteem_BerekendeAfstandVergunningplicht
