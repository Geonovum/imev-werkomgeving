...
- Aanpassing: Regel is aangepast: In de regel bij het objecttype ExterneVeiligheidsObject werd gesteld: _bronhoudercodeOverheid en/of bronhoudercodeGeenOverheid moet gevuld zijn._ 
...
- Milieu Belastende Activiteit(en): (VII-A.12)
...
- Aanpassing: Typefout in de regel is verbeterd: Er stond: _idActiviteitTR=imow-mnre1034.activiteit.OpstellenVoertuigGevaarlStoffen_ en er staat nu _idActiviteitTR=nl.imow-mnre1034.activiteit.OpstellenVoertuigGevaarlStoffen_ 
