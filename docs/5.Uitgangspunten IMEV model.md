...
- In een logisch model is de naamgeving van termen in model hoofdlettergevoelig en zijn spaties niet toegestaan.
...
Voor de definities van de term wordt dan ook naar deze [objectcatalogus](https://docs.geostandaarden.nl/imev/imev/#objecttypen) gerefereerd.
