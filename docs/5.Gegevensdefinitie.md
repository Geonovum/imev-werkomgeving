...
**Dit hoofdstuk beschrijft het inforantiemodel van de dataspecificatie.**
...
- IMEV bevat locatie-gebonden-informatie en conformeert aan NEN 3610, de Basismodel voor Geo-informatie.
...
Tabel met diagrammen die in het IMEV enterprise architect zijn gemaakt. Bij het veld opmerking is aangegeven of het diagram is opgenomen in dit IMEV document. Het is voor de controle op volledigheid van gemaakte en gepubliceerde diagrammen. Er zijn een aantal diagrammen waarvan niet duidelijk is waar de activeit in Bkl wordt benoemd. In de uiteindelijk te publiceren versie moet deze tabel verplaatst worden naar een bijlage.
...
De classificatie van typen activiteiten met plaatsgebonden risico volgt de indeling van Bijlage VII, VIII, IX, X1 van het Besluit kwaliteit leefomgeving.
...
<figure id="afb_IMEV - CL1-Opslag gevaarlijke stoffen met EVContour">
    ...
    <figcaption>IMEV - VIIE3-Opslagtank voor gassenr</figcaption>
</figure>
...
<figure id="afb_IMEV - CL1-Opslag gevaarlijke stoffen met EVContour">
    <img src="docs/media/IMEV - CL1-IXC3-OpslagOntplofbaarADR1.4Civiel.png" alt="Afbeelding IMEV - CL1-Opslag gevaarlijke stoffen met EVContour">
    <figcaption>IMEV - IXC3--Vastgestelde civiele explosieaandachtsgebieden</figcaption>
</figure>
