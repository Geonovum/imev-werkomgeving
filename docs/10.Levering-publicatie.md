...
<p class="note">
Nadere details en instructies voor de API koppeling met het REV zijn gepubliceerd in het document REV Aanleveringstructie (zie [https://registerexterneveiligheid.nl/](https://registerexterneveiligheid.nl/).</p>
...
Het IMEV JSON formaat wordt beschreven aan de hand van JSON voorbeeldbestanden (zie [https://registerexterneveiligheid.nl/](https://registerexterneveiligheid.nl/).
