...
<tr>
  ...
  <td><xsl:value-of select="mim:naam"/></td>
  <td><xsl:value-of select="mim:type/mim-ref:InterfaceRef|mim:type/mim-ref:DatatypeRef|mim:type/mim:Datatype|mim:type/mim-ref:KeuzeRef|mim:type/mim-ext:ConstructieRef"/></td>
